...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border-2 border-white bg-black ring-offset-black transition-all hover:scale-115 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7089ba] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-grab hover:border-[#7089ba]" />
  </SliderPrimitive.Root>
))
